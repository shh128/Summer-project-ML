...
def fillna_ind(df, method, ffi):
    ...
    df_fill['level_0'] = df_fill['level_0'].astype(str)
    df_fill['level_1'] = df_fill['level_1'].astype(str)
    index_temp = df_fill[['level_0', 'level_1']]
    ...
    df_fill = df_fill.drop(['level_0'], axis=1)
    df_fill = df_fill.drop(['level_1'], axis=1)
